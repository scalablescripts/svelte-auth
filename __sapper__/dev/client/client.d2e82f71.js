...
const components = [
	{
		js: () => Promise.all([import('./index.38558c1d.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.2b2c247e.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.30ee3b3e.js'), ]).then(function(x) { return x[0]; })
	}
];
