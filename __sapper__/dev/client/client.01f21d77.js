...
const components = [
	{
		js: () => Promise.all([import('./index.3c434421.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.cb91e21d.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.0f7d50fc.js'), ]).then(function(x) { return x[0]; })
	}
];
