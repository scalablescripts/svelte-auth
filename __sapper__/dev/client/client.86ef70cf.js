...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 26, 24, 833);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 25, 20, 787);
			attr_dev(a1, "href", "/register");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 29, 24, 969);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 28, 20, 923);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 24, 16, 722);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(a0, "href", "/login");
			attr_dev(a0, "class", "nav-link");
			add_location(a0, file$2, 17, 24, 451);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 16, 20, 405);
			attr_dev(a1, "href", "/register");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 20, 24, 587);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 19, 20, 541);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
...
const components = [
	{
		js: () => Promise.all([import('./index.87f572b1.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.865565c1.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.e5a4305d.js'), ]).then(function(x) { return x[0]; })
	}
];
