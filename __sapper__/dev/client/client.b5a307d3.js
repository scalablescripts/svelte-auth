...
const components = [
	{
		js: () => Promise.all([import('./index.dc43ec14.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.e10a25e2.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.03f3c3c0.js'), ]).then(function(x) { return x[0]; })
	}
];
