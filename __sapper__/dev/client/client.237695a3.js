...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 34, 24, 1010);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 33, 20, 964);
			attr_dev(a1, "href", "/register");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 37, 24, 1146);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 36, 20, 1100);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 32, 16, 899);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 28, 24, 756);
			attr_dev(li, "class", "nav-item");
			add_location(li, file$2, 27, 20, 710);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 26, 16, 645);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 22, 8, 549);
			add_location(div0, file$2, 24, 8, 600);
			attr_dev(div1, "class", "container-fluid");
			add_location(div1, file$2, 21, 4, 511);
			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark bg-dark mb-4");
			add_location(nav, file$2, 20, 0, 444);
		},
		m: function mount(target, anchor) {
...
const components = [
	{
		js: () => Promise.all([import('./index.d7c6b784.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.9eee737b.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.beb19f45.js'), ]).then(function(x) { return x[0]; })
	}
];
