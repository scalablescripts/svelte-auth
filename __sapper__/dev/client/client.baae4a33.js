...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 2, 8, 105);
			attr_dev(a1, "href", "/login");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 7, 20, 277);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 6, 16, 235);
			attr_dev(a2, "href", "/register");
			attr_dev(a2, "class", "nav-link");
			add_location(a2, file$2, 10, 20, 401);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 9, 16, 359);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 5, 12, 174);
			add_location(div0, file$2, 4, 8, 156);
...
const components = [
	{
		js: () => Promise.all([import('./index.b248f796.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.32a2daf6.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.bb45f39e.js'), ]).then(function(x) { return x[0]; })
	}
];
