...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 27, 24, 740);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 26, 20, 694);
			attr_dev(a1, "href", "/register");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 30, 24, 876);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 29, 20, 830);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 25, 16, 629);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 21, 24, 486);
			attr_dev(li, "class", "nav-item");
			add_location(li, file$2, 20, 20, 440);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 19, 16, 375);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 15, 8, 279);
			add_location(div0, file$2, 17, 8, 330);
			attr_dev(div1, "class", "container-fluid");
			add_location(div1, file$2, 14, 4, 241);
			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark bg-dark mb-4");
			add_location(nav, file$2, 13, 0, 174);
		},
		m: function mount(target, anchor) {
...
const components = [
	{
		js: () => Promise.all([import('./index.e9d12ba1.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.f1385903.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.38812860.js'), ]).then(function(x) { return x[0]; })
	}
];
