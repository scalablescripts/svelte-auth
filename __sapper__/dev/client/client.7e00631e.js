...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 27, 24, 746);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 26, 20, 700);
			attr_dev(a1, "href", "/register");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 30, 24, 882);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 29, 20, 836);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 25, 16, 635);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 21, 24, 492);
			attr_dev(li, "class", "nav-item");
			add_location(li, file$2, 20, 20, 446);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 19, 16, 381);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 15, 8, 285);
			add_location(div0, file$2, 17, 8, 336);
			attr_dev(div1, "class", "container-fluid");
			add_location(div1, file$2, 14, 4, 247);
			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark bg-dark mb-4");
			add_location(nav, file$2, 13, 0, 180);
		},
		m: function mount(target, anchor) {
...
const components = [
	{
		js: () => Promise.all([import('./index.b7303c88.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.c0f8baac.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.9f74015a.js'), ]).then(function(x) { return x[0]; })
	}
];
