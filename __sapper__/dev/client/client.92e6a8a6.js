...
const components = [
	{
		js: () => Promise.all([import('./index.ad03073f.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.4077d713.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.07bf550d.js'), ]).then(function(x) { return x[0]; })
	}
];
