...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 27, 24, 748);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 26, 20, 702);
			attr_dev(a1, "href", "/register");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 30, 24, 884);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 29, 20, 838);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 25, 16, 637);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 21, 24, 494);
			attr_dev(li, "class", "nav-item");
			add_location(li, file$2, 20, 20, 448);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 19, 16, 383);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 15, 8, 287);
			add_location(div0, file$2, 17, 8, 338);
			attr_dev(div1, "class", "container-fluid");
			add_location(div1, file$2, 14, 4, 249);
			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark bg-dark mb-4");
			add_location(nav, file$2, 13, 0, 182);
		},
		m: function mount(target, anchor) {
...
const components = [
	{
		js: () => Promise.all([import('./index.7399de02.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.487d7443.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.ced704bc.js'), ]).then(function(x) { return x[0]; })
	}
];
