...
const components = [
	{
		js: () => Promise.all([import('./index.50bf4ade.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.b48163bf.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.0944e5ed.js'), ]).then(function(x) { return x[0]; })
	}
];
