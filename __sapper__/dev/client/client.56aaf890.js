...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 23, 24, 687);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 22, 20, 641);
			attr_dev(a1, "href", "/register");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 26, 24, 823);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 25, 20, 777);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 21, 16, 576);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 17, 24, 451);
			attr_dev(li, "class", "nav-item");
			add_location(li, file$2, 16, 20, 405);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 15, 16, 340);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 11, 8, 244);
			add_location(div0, file$2, 13, 8, 295);
			attr_dev(div1, "class", "container-fluid");
			add_location(div1, file$2, 10, 4, 206);
			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark bg-dark mb-4");
			add_location(nav, file$2, 9, 0, 139);
		},
		m: function mount(target, anchor) {
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ authenticated, auth });
...
const components = [
	{
		js: () => Promise.all([import('./index.022931e4.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.73c668c5.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.ffcf065d.js'), ]).then(function(x) { return x[0]; })
	}
];
