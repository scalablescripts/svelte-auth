...
const components = [
	{
		js: () => Promise.all([import('./index.cdfe9656.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.4d5ada03.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.3d3d9330.js'), ]).then(function(x) { return x[0]; })
	}
];
