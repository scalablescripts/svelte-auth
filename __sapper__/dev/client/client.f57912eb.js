...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 30, 24, 909);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 29, 20, 863);
			attr_dev(a1, "href", "/register");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 33, 24, 1045);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 32, 20, 999);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 28, 16, 798);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 24, 24, 655);
			attr_dev(li, "class", "nav-item");
			add_location(li, file$2, 23, 20, 609);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 22, 16, 544);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 18, 8, 448);
			add_location(div0, file$2, 20, 8, 499);
			attr_dev(div1, "class", "container-fluid");
			add_location(div1, file$2, 17, 4, 410);
			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark bg-dark mb-4");
			add_location(nav, file$2, 16, 0, 343);
		},
		m: function mount(target, anchor) {
...
const components = [
	{
		js: () => Promise.all([import('./index.902e4ed2.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.ab61f6d7.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.151ec278.js'), ]).then(function(x) { return x[0]; })
	}
];
