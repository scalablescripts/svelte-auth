...
const components = [
	{
		js: () => Promise.all([import('./index.9274d88e.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.8247e7af.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.798b20cd.js'), ]).then(function(x) { return x[0]; })
	}
];
