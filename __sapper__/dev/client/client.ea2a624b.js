...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 11, 8, 244);
			attr_dev(a1, "href", "/login");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 16, 20, 416);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 15, 16, 374);
			attr_dev(a2, "href", "/register");
			attr_dev(a2, "class", "nav-link");
			add_location(a2, file$2, 19, 20, 540);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 18, 16, 498);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 14, 12, 313);
...
const components = [
	{
		js: () => Promise.all([import('./index.5955edcd.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.d1b22889.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.c3e54113.js'), ]).then(function(x) { return x[0]; })
	}
];
