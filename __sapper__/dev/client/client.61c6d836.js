...
const components = [
	{
		js: () => Promise.all([import('./index.37d37774.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.fffd35ab.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.d22bbb1d.js'), ]).then(function(x) { return x[0]; })
	}
];
