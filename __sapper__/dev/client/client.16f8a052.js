...
const components = [
	{
		js: () => Promise.all([import('./index.fa19b668.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.91662eb7.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.35b30186.js'), ]).then(function(x) { return x[0]; })
	}
];
