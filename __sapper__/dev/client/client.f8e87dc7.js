...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 31, 24, 937);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 30, 20, 891);
			attr_dev(a1, "href", "/register");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 34, 24, 1073);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 33, 20, 1027);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 29, 16, 826);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 25, 24, 683);
			attr_dev(li, "class", "nav-item");
			add_location(li, file$2, 24, 20, 637);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 23, 16, 572);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 19, 8, 476);
			add_location(div0, file$2, 21, 8, 527);
			attr_dev(div1, "class", "container-fluid");
			add_location(div1, file$2, 18, 4, 438);
			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark bg-dark mb-4");
			add_location(nav, file$2, 17, 0, 371);
		},
		m: function mount(target, anchor) {
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ authenticated, auth, logout });
...
const components = [
	{
		js: () => Promise.all([import('./index.cf98863c.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.0f0eece9.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.74714504.js'), ]).then(function(x) { return x[0]; })
	}
];
