...
const components = [
	{
		js: () => Promise.all([import('./index.a1a0f9b3.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.8530951e.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.9dcbda49.js'), ]).then(function(x) { return x[0]; })
	}
];
