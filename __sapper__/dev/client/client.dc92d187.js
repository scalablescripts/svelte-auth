...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t4 = claim_text(a2_nodes, "Register");
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 7, 8, 131);
			attr_dev(a1, "href", "/login");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 12, 20, 303);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 11, 16, 261);
			attr_dev(a2, "href", "/register");
			attr_dev(a2, "class", "nav-link");
			add_location(a2, file$2, 15, 20, 427);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 14, 16, 385);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 10, 12, 200);
			add_location(div0, file$2, 9, 8, 182);
			attr_dev(div1, "class", "container-fluid");
			add_location(div1, file$2, 6, 4, 93);
			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark bg-dark mb-4");
			add_location(nav, file$2, 5, 0, 26);
		},
...
const components = [
	{
		js: () => Promise.all([import('./index.11efb4c8.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.3e45f1b3.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.9edf8356.js'), ]).then(function(x) { return x[0]; })
	}
];
